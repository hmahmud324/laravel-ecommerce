...
<head>
    ...
    <style>
        p[data-timeout] {
            opacity: 1;
            animation: remove-flash-message 5s linear forwards;
        }

        @keyframes remove-flash-message {
            to {
                opacity: 0;
                display: none;
            }
                ...
                <div class="main-sidemenu">
                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="{{route('sub-category.add')}}" class="slide-item">Add Sub Category</a></li>
                                <li><a href="{{route('sub-category.manage')}}" class="slide-item">Manage Sub
                                        Category</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="file-attachments.html" class="slide-item">Manage Customer</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a href="settings.html" class="slide-item">Add User</a></li>
                                <li><a href="profile.html" class="slide-item">Manage User</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Setting Module</span><i
                                    class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li><a href="opacity.html" class="slide-item">Manage Company</a></li>
                                <li><a href="emptypage.html" class="slide-item">Manage Offer</a></li>
                            </ul>
                        </li>
                    </ul>
                                            ...
                                            <div class="media mb-5 overflow-visible">
                                                <div class="me-3">
                                                    <a href="profile.html"> <img
                                                            ...
                                                            src="{{asset('/')}}admin/assets/images/users/2.jpg"> </a>
                                                </div>
