...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
          href="{{asset('/')}}website/{{asset('/')}}website/assets/images/favicon.svg"/>
                    ...
                    @else
                        <div class="top-end">
                            <ul class="user-login">
                                ...
                                <li>
                                    <a href="{{route('customer.registration')}}">Register</a>
                                </li>
                            </ul>
                        </div>
                    @endif
                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        @foreach(Cart::content() as $item)
                                            <li>
                                                <a href="{{route('cart.delete',['id'=>$item->rowId])}}" class="remove"
                                                   title="Remove this item"><i
                                                        class="lni lni-close"></i></a>
                                                <div class="cart-img-head">
                                                    <a class="cart-img"
                                                       href="{{route('product-details',['id'=>$item->rowId])}}"><img
                                                            src="{{asset($item->options->image)}}"
                                                            alt="#"></a>
                                                </div>
                                                <div class="content">
                                                    <h4><a href="{{route('product-details',['id'=>$item->rowId])}}">
                                                            {{$item->name}}</a></h4>
                    ...
                    <div class="mega-category-menu">
                        ...
                        <ul class="sub-category">
                            @foreach($categories as $category)
                                <li><a href="{{route('product-category',['id'=>$category->id])}}">
                                        {{$category->name}}
                                    ...
                                    @if(count($category->subCategory) > 0)
                                        <ul class="inner-sub-category">
                                            @foreach($category->subCategory as $subCategory)
                                                <li>
                                                    <a href="{{route('product-details',['id'=>$subCategory->id])}}">{{$subCategory->name}}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    @endif
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    <a class="" href="{{ route('all-product') }}">Shop</a>
                                </li>
                                <li class="nav-item">
                                    <a class="dd-menu collapsed" href="javascript:void(0)" data-bs-toggle="collapse"
...
<script>
    const finaleDate = new Date("September 4, 2023 00:00:00").getTime();
