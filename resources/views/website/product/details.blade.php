                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{asset($product->image)}}" id="current" alt="#" height="600">
                                </div>
                                <div class="images">
                                    <img src="{{asset($product->image)}}" class="img" alt="#" height="100">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category">
                                <i class="lni lni-tag"></i>Product Sub Category
                            ...
                            <h3 class="price"><span>&#2547;</span>{{$product->selling_price}}<span><span>&#2547;</span>{{$product->regular_price}}</span>
                            </h3>
